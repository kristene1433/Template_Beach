                  ...
                  {payments.length > 0 ? (
                    <div className="space-y-3">
                      <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                        <div className="flex items-center justify-between">
                          <div>
                            <h5 className="text-sm font-medium text-blue-900">Total Paid</h5>
                            <p className="text-xs text-blue-700">All successful payments</p>
                          </div>
                          <div className="text-right">
                            ...
                            <p className="text-xs text-blue-600">
                              {payments.filter(payment => payment.status === 'succeeded').length} successful
                            </p>
                          </div>
                        </div>
                      </div>
