...
const ApplicationView = () => {
  ...
  const calculatePaymentTotals = () => {
    ...
    // Calculate total owed (deposit + rental amount)
    const depositAmount = application.depositAmount || 500; // Default $500 deposit
    const rentalAmount = application.rentalAmount || 2500; // Default $2500 rent
    const totalOwed = depositAmount + rentalAmount;
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="text-center">
                            ...
                            <p className="text-xs text-blue-700">
                              ${application?.depositAmount || 500} deposit + ${application?.rentalAmount || 2500} rent
                            </p>
                          </div>
                          <div className="text-center">
