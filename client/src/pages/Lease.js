                ...
                {!leaseContent && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                    <div className="flex items-start">
                      ...
                      <div className="text-sm text-blue-800">
                        <p className="font-medium">
                          {leaseData.leaseStartDate && leaseData.leaseEndDate ? 'Lease Generation' : 'Waiting for Lease Generation'}
                        </p>
                        <p className="mt-1">
                          {leaseData.leaseStartDate && leaseData.leaseEndDate
                            ? 'Lease agreements are generated by administrators. If you need a new lease generated, please contact the property management team.'
                            : 'Your lease agreement has not been generated yet by an administrator. Please wait for the property management team to create your lease.'
                          }
                        </p>
                      </div>
                    </div>
